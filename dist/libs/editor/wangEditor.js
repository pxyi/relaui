...
Code.prototype = {
    ...
    _insertCode: function _insertCode(value) {
        var editor = this.editor;
        editor.cmd.do('insertHTML', '<pre style="border: solid 1px #ccc; padding: 8px; background: #f1f1f1; border-radius: 3px;"><code>' + value + '</code></pre><p><br></p>');
    },
...
UploadImg.prototype = {
    ...
    insertLinkImg: function insertLinkImg(link) {
        ...
        img.onload = function () {
            img = null;
            editor.cmd.do('insertHTML', '<img src="' + link + '" style="max-width:100%;display:inline-block;"/>');
        };
...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        if (textSelector == null) {
            ...
            $textContainerElem.css('border', '1px solid #ccc').css('border-top', 'none').css('height', '340px');
        } else {
